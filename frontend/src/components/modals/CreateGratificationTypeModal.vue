...
const onSubmit = (payload: any) => {
  loading.value = true
  const route = "payrolls/gratifications/types/create"
...
const onEdit = (payload: any) => {
  loading.value = true
  const route = "payrolls/gratifications/types"
...
<template>
  <form-modal
    :show="state.show"
    :title="state.isEdit ? 'Editar gratificante' : 'Nuevo gratificante'"
    modal-name="formCreateGratificationTypeModal"
