    ...
    <div class="mt-4 row">
      <div class="col-12">
        <div class="card">
          ...
          >
            <div>
              <h5 class="mb-0">Descuentos programados</h5>
              <p class="mb-0 text-sm">
                A continuación se listan todos los descuentos programados
                aplicados a agentes.
              </p>
            </div>
            <div>
          ...
          <div class="table-responsive">
            <base-table
              ...
              :columns="[
                ...
                {
                  label: 'Code - descuento',
                  prop: 'discount_type_detail',
                  minWidth: 180,
                },
                {
                  label: 'Valor',
              ...
              endpoint="/payrolls/discounts/scheduled/table"
            >
